...
<h1><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page_top' target='_blank' title='GARD Pro Official Website'>GET GARD PRO TODAY</a></h1>
<b>Upgrade to <a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank'>GARD Pro</a> today</b>

<ul style='list-style: disc;margin-left:50px;'>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>100% MONEY BACK GUARANTEE</b></a> - 180 day money back guarantee! If at anytime in the first 180 days after your purchase of GARD Pro, you decide that you want a refund, just ask! No questions asked, 100% money back guarantee. We want you to be satisfied, with our product. If you want features added, please ask!</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>WORKS ON ALL DEVICES</b></a> - The driving force behind GARD Pro is that it works on any device. No matter how your website visitors choose to access your website, rest assured that GARD Pro will serve up the right sized AdSense ad.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>FREE UPGRADES FOR LIFE</b></a> - Anytime we have an upgraded version of GARD Pro available, you’ll get it free! Forever! Updating is super easy. Update GARD Pro as you do any other WordPress plugin, right in your WordPress dashboard.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>5 AD WIDGETS INCLUDED</b></a> - GARD Pro includes 5 custom ad widgets! One for each custom group. You can have a widget for responsive banners, one for responsive skyscrapers, one for responsive squares, one for responsive rectangles, and one for link units.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>ADSENSE POLICY COMPLIANT</b></a> - GARD Pro enforces Google AdSense policies. We limit image ads to 3 per page, text ads to 3 per page, and 300×600 ads to one per page. Never worry about being banned for misuse of AdSense!</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>5 AD GROUPS</b></a> - Create ad groups. This allows you to have groups specific to links, banners, skyscrapers, etc.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>CUSTOM SHORTCODE</b></a> - Define a custom shortcode for inserting each group into the content.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>AUTO INSERT</b></a> - Auto insert responsive AdSense ads into user specified content types.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>MAGIC TOOL INCLUDED</b></a> - With our Magic tool, you can simply paste your current AdSense code, and click a single button to insert it into the GARD Pro settings page.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>PERFECT FOR BEGINNERS AND ADVANCED USERS</b></a> - Every GARD Pro config page has two modes, BASIC and ADVANCED. Basic mode provides faster and easier setup, while Advanced mode offers better ad tracking, and more flexible styling.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>EASILY CLONE AD GROUPS</b></a> - Every ad group has the ability to be cloned for ease of setup. Set up all your ads once, then clone that group for different styling, or anything else you can imagine!</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>FILTER OUT BAD THINGS</b></a> - Have an article on gambling that you don’t want ads on? No problem. What about a website linking to you that you don’t want to show ads to the visitors of? Piece of cake. Want to block ads to your work and home computers? Easy peasy.</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>SUGGESTED SIZES</b></a> - We label ad sizes which are best for certain areas, such as your sidebar, or header. If you use the Basic Group Settings mode, then all you have to do is check the boxes next to the size you want!</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>SETS UP IN UNDER 2 MINUTES</b></a> - With GARD Pro, you can easily set up AdSense that fits every screen size possible. Just drop in your publisher ID, check a few boxes, and you can be up and running in less than 2 minutes!</li>
	<li><a href='<?php echo GARD_PRO_DEMO_LINK ?>?=GARD_PRO_DEMO_page' target='_blank' title='GARD Pro Official Website'><b>ANYTIME UPGRADE</b></a> - You can upgrade anytime with NO PENALTY. Just post in our support forums letting us know that you want to upgrade your license. We’ll send you a coupon good for the purchase price of your initial purchase. You can use this discount towards any package above the level you previously purchased.</li>
</ul>